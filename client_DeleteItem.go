...
// Invoke invokes the DeleteItem operation in a goroutine and returns a BatchGetItemAllPromise
...
func (op *DeleteItem) invoke(ctx context.Context, client *ddb.Client) {
